...
import { Mail, Lock, ArrowRight, Eye, EyeOff, AlertCircle, Sun, Moon } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        <div className="bg-surface/80 backdrop-blur-xl border border-border rounded-3xl p-8 shadow-2xl">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-text-secondary mt-1">Sign in to continue building your career</p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full bg-background border border-border rounded-xl pl-11 pr-12 py-3 text-sm text-text-main placeholder:text-text-muted outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/10 transition-all"
                />
                <button
                  type="button"
